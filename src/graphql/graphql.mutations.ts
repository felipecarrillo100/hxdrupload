...
export const CreateAssetV3 = gql`mutation createAsset($params: CreateAssetInputV3!) {
...
export const CreateAssetV2 = gql`mutation createAsset($params: CreateAssetInput!) {
